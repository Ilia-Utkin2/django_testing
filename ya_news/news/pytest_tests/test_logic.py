...
@pytest.mark.django_db
def test_user_can_create_comment(author_client, news_detail_url, form_data, author, news):
...
def test_author_can_edit_comment(author_client, edit_url, new_form_data, comment, url_to_comments):
...
def test_user_cant_edit_comment_of_another_user(not_author_client, comment, edit_url, new_form_data, form_data):
